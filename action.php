<?php
            ...
            while($row=mysqli_fetch_array($run_query)){
                ...
                <div class='panel panel-info'>
                    ...
                    <div class='panel-heading'>
                        $.$pro_price.00 <button pid='$pro_id' style='float:right' id='product' class='btn btn-danger btn-xs'>AddToCart</button>
                    </div>
                </div>
    ...
    if(isset($_POST["addToProduct"])){
        ...
        if($count>0){
            ...
            echo "<div class='alert alert-success'>
                <a href='' class='close' data-dismiss='alert' aria-label='close'>&times;</a><b>Please Login At First To Continue Shopping..!</b>.
              </div>";
        }
        ...
        if($count>0){
            ...
            while($row=mysqli_fetch_array($run_query)){
                ...
                if(isset($_POST["get_cart_product"])){
                    ...
                    <div class='col-md-2'><img src='product_images/$pro_image' width='50px' height='60px' alt='No image'></div>
            ...
            echo '<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
                ...
                <input type="hidden" name="business" value="sb-spqlo3227896@personal.example.com">
