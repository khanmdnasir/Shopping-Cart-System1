    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                ...
                <li style="left:20px;top:10px"><button class="btn btn-primary"  id="search_btn_index">Search</button></li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
                <li><a href="#"  class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-shopping-cart"></span> Cart <span class="">0</span></a>
                    ...
                    <ul class="dropdown-menu">
                        <div style="width:300px">
                            ...
                            <form  method="POST">
                                ...
                                <br>
                                <a href="#" style="color:Black;list-style:none">Forgotten Password</a>
                                <input type="submit" class="btn btn-success" style="float:right"  value="Login" id="login">
                            </form>
                            </div>
                            <div class="panel-footer" id="e_msg" style="text-align:center"><a href="customer_registration.php" >new here?create account</a></div>
                            </div>
                        </div>
                    </ul>
                </li>
